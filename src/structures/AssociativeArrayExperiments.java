...
public class AssociativeArrayExperiments {
    ...
    public static void expreimentStringsToStrings(PrintWriter pen) throws Exception {
        ...
        try { s2s.get("a"); } catch (Exception e) { }
        try { s2s.get("A"); } catch (Exception e) { }
        try { s2s.set(null, "haha"); } catch (Exception e) { }
        try { s2s.set("ye", null); } catch (Exception e) { }
        try { s2s.set(null, null); } catch (Exception e) { }
...
} // structures.AssociativeArrayExperiments
